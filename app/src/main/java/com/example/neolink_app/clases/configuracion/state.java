...
public class state {
    ...
    public state(){}
    public state(String Firmware, stateGPS GPS, String Hardware_ver, String IP, double LastOP_TIME, String LastUpload, statelimitsport Limits, double NewConf, statenotification Notification, statePortsactive Port, String WiFi_rssi){
    ...
    public String dameFirmware(){return Firmware;}
