...
public class Confvalues {
    ...
    public void confvalues(double BAT_H, double BAT_L, double BEEP_EN, double GPS_RQ, double NO_WIFI, double N_END_HOUR, double N_SLEEP_TIME, double N_START_HOUR, double PORT_RQ, int SLEEP_TIME, String WIFI_PSSWD_DEFAULT, String WIFI_SSID_DEFAULT,double aux){
        this.BAT_H = BAT_H;
        this.BAT_L = BAT_L;
