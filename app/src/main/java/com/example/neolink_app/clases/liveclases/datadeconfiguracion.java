...
public class datadeconfiguracion<A,B> extends MediatorLiveData<Pair<A,B>> {
    private A dataa;
    private B datab;
    public boolean validateA = false;
    public boolean validateB = false;

    public datadeconfiguracion(){}
    public datadeconfiguracion(LiveData<A> ld1, LiveData<B> ld2){
